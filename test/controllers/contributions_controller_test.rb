...
class ContributionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contribution" do
    assert_difference("Contribution.count") do
      post contributions_url, params: { contribution: { amount: @contribution.amount, contribution_date: @contribution.contribution_date, event_id: @contribution.event_id, user_id: @contribution.user_id } }
    end
  ...
  test "should update contribution" do
    patch contribution_url(@contribution), params: { contribution: { amount: @contribution.amount, contribution_date: @contribution.contribution_date, event_id: @contribution.event_id, user_id: @contribution.user_id } }
